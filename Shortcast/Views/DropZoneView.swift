...
struct DropZoneView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog("Download yt-dlp?", isPresented: $showInstallPrompt) {
            ...
            Text("YouTube videos are downloaded with yt-dlp, a small open-source tool. Shortcast fetches the official build (checksum-verified) into Application Support — it's never bundled, and you can delete it any time.")
        }
    }
